...
void main()
{
    int num1,num2,Sum_C_F;
    printf("Enter two number: ");
    scanf("%d%d",&num1,&num2);//Enter two numbers 84    105
    Sum_C_F=Smallest_common_factor(num1,num2); //calling the function through a variable
    printf("Sum of common factors is: %d",Sum_C_F); //print the returned result 31
}
                /*  Secondary Function*/
